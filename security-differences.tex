If a closed source developer adds malicious code into their product, then according to Stallman, its users are left powerless to fix it\citeyear[para. 36]{rms2011}.
